...
patrones = {
    ...
    'DATA_TYPE': r'\b(int|byte|float|double|char|String|boolean|long|short|var)\b',
    'DATA_TYPE_ADICIONAL': r'\b(void|abstract|class|final|static|interface)\b',
    'OPERATOR_ASSIGN': r'(=)',
    'OPERATOR': r'(\+\+|--|==|!=|<=|>=|&&|\|\||[+\-*/%<>&|!])',
    'SEPARATOR': r'[,\[\]{}()]',
    'TERMINAL_EXPRESSION': r'(;)',
